...
zFBX.fileReader = function(){

};


zFBX.parser = function(str){
    var o = {};
    var i = 0;
    var size = str.length;
    var comment = false;
...
zFBX.parseNumber = function(str, i){
    var o = ['',NaN];
    var floatFlag = false;
...
zFBX.parse_09azAZ = function(str, i){
    var o = [str[i],NaN];
    i++;
...
zFBX.checkPropName = function(node, name){
    if(node[name]){
        var i = 1;
        while(node[name+i])
            i++;
...
zFBX.get_Objects = function(FBX){
    return FBX.Objects;
};

zFBX.get_ModelCount = function(FBXdefinitions){
...
zFBX.get_Model = function(FBX, modelName){
...
zFBX.get_rawBasicMesh = function(FBX, objName){
...
zFBX.get_availableProps = function(zFBXrawBasicMesh){
    var possible = ["c","u","n"];
    var available = [];
